...
| LogFile               | A path under which log file will be created.                                                                                                                                                                                                                                           | ``` data/log_frontend.txt ```         |
...
Peernet Browser scans DLLs from inside these folders, selects DLLs which match assembly name pattern __Peernet.Browser.Plugins.*__ , istantiates classes which implement __IPlugin__ interface and executes their _Load_ methods.
